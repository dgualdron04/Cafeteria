                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium w-6">
                                    <a href="{{route('subcategories.show', $subcategory)}}" class="text-yellow-600 hover:text-yellow-800">Show</a>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium w-6">
                                    <a href="{{route('subcategories.edit', $subcategory)}}" class="text-yellow-600 hover:text-yellow-800">Edit</a>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium w-6">
