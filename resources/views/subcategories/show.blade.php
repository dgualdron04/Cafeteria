    ...
    <div class="w-full h-screen bg-gradient-to-br from-gray-200 via-yellow-50 to-gray-50 flex flex-no-wrap overflow-auto">
        ...
        <div class=" ml-16 sm:ml-80 pr-16 pt-14 pb-12 w-full h-full flex flex-wrap items-center justify-center">
            <div class="w-full flex justify-between">
                <a href="{{route('subcategories.index')}}" class="text-yellow-600 hover:text-yellow-700"><< Volver</a>
                <a href="{{route('subcategories.edit', $subcategory)}}" class="text-yellow-600 hover:text-yellow-700">Editar {{$subcategory->name}} >></a>
            </div>
                    ...
                    <div class="container">
                        <div class="bg-white rounded-lg shadow-lg mb-6">
                            <div class="px-6 py-4 flex justify-between items-center">
                                <h1 class="font-bold text-xl text-gray-700 uppercase">{{$subcategory->name}}</h1>
                                <h1 class="font-bold text-xl text-gray-700 uppercase">{{$subcategory->category->name}}</h1>
                            </div>
                        </div>
                    </div>
